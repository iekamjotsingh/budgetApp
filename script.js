  ...
  return {
    ...
    addListItem: function (obj, type) {
      ...
      if (type === "inc") {
        ...
        html =
          '<div class="item clearfix" id="exp-%id%"><div class="item__description">%description%</div><div class="right clearfix"><div class="item__value">%value%</div><div class="item__percentage"></div><div class="item__delete"><button class="item__delete--btn"><i class="far fa-times-circle"></i></button></div></div></div>';
      }
    ...
    displayMonth : function(){
      ...
      document.querySelector(DOMstrings.dateLabel).textContent =date + '/' +month+ '/' + year;
    },
...
// APP MODULE - Link between UI and DATA MODULES
// We will pass two modules here as parameters
